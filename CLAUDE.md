...
- Mock external services in tests (Anthropic, Convex)
...
This project is indexed by GitNexus as **A2A-Hub** (2519 symbols, 4109 relationships, 103 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
...
| Resource | Use for |
|----------|---------|
| `gitnexus://repo/A2A-Hub/context` | Codebase overview, check index freshness |
| `gitnexus://repo/A2A-Hub/clusters` | All functional areas |
| `gitnexus://repo/A2A-Hub/processes` | All execution flows |
| `gitnexus://repo/A2A-Hub/process/{name}` | Step-by-step execution trace |
